            ...
            {isLoading && (
              <div className="flex gap-3 items-start animate-pulse">
                ...
                <div className="flex flex-col gap-1">
                  <span className="text-xs font-bold text-slate-600 italic uppercase tracking-wide">Hệ thống đang xử lý...</span>
                  <span className="text-[11px] text-slate-500">⏳ Vui lòng chờ (có thể mất vài phút)</span>
                </div>
              </div>
            )}
            ...
            <div className="relative group w-full">
              ...
              <div className="relative bg-white border border-slate-200 rounded-[24px] p-1.5 flex items-center gap-3 shadow-[0_4px_20px_rgba(0,0,0,0.03)] focus-within:border-blue-400/40 focus-within:shadow-[0_8px_30px_rgba(30,91,141,0.08)] transition-all duration-300 w-full">
                ...
                <button
                  ...
                  className="w-12 h-11 rounded-[18px] bg-gradient-to-br from-[#1e5b8d] to-[#0d4a73] text-white flex items-center justify-center shadow-lg shadow-blue-900/40
