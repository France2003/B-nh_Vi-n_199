    ...
    return (
      <>
        ...
        <label
          ...
          className="flex items-center justify-center w-9 h-9 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 text-white cursor-pointer hover:shadow-md transition-transform active:scale-95 flex-shrink-0"
          title="Tải file"
