      ...
      <div className="bg-white border-t border-gray-200 px-4 py-4 shadow-lg">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex gap-3 items-end">
            <div className="flex-1 flex items-center gap-2 bg-gray-100 border border-gray-300 rounded-2xl px-4 py-3 transition-all focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-200 hover:border-gray-400">
