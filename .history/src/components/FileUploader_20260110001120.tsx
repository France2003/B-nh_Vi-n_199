    ...
    return (
      <>
        ...
        <label
          ...
          className="flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-blue-700 text-white cursor-pointer hover:shadow-lg hover:scale-110 transition-all active:scale-95 flex-shrink-0"
          title="Tải file"
