...
export const FileUploader: React.FC<FileUploaderProps> = ({ onFilesUpload }) => {
  ...
  return (
    <div
      ...
      style={{
        borderColor: isDragActive ? '#2a7bb7' : '#1e5b8d',
        backgroundColor: isDragActive ? '#e8f4fb' : '#f0f7fc'
      }}
    ...
    >
      ...
      <div className="pointer-events-none">
        ...
        <p className="m-0 mb-1 text-base font-semibold text-gray-700" style={{color: '#1e5b8d'}}>Kéo và thả tệp hoặc nhấp để chọn</p>
