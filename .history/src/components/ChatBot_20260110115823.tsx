  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      <div className="flex-1 overflow-y-auto py-8">
        <div className="w-full space-y-6 px-4 sm:px-10 lg:px-20">
          {messages.map((m) => (
      ...
      <div className="border-t bg-white px-4 py-4">
        <div className="w-full max-w-6xl mx-auto">
          ...
          <div className="flex items-center gap-3 mt-3">
            <div className="flex flex-1 items-center gap-2 border rounded-2xl px-3 py-2">
              <FileUploader
            ...
            <button
              ...
              className="w-11 h-11 rounded-full bg-blue-600 text-white font-bold hover:scale-105 transition disabled:opacity-50"
            >
              →
            </button>
          </div>
