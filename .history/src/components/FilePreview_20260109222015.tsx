...
export const FilePreview: React.FC<FilePreviewProps> = ({
  ...
  return (
    <div className="mb-4 p-3 rounded-lg border" style={{backgroundColor: '#f0f7fc', borderColor: '#dceef9'}}>
        ...
        {files.map((file) => (
          <div key={file.id} className="flex gap-3 p-3 bg-white rounded-lg border border-gray-200 items-start">
            {file.type === 'image' && file.preview ? (
              ...
              <div className="w-20 h-20 flex items-center justify-center bg-gray-50 rounded-lg flex-shrink-0" style={{color: '#1e5b8d'}}>
            ...
            <div className="flex-1 flex flex-col gap-2">
              ...
              <input
                ...
                className="w-full px-3 py-2 border rounded text-sm text-gray-900 bg-white font-sans placeholder-gray-400 transition-all focus:outline-none focus:shadow-sm"
