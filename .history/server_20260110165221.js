...
const app = express();
const PORT = 3001;
const FLOWISE_API_URL = 'hhttps://flowise.imagentu.cloud/api/v1/prediction/91407fb6-0d73-41f9-baee-6dfda1fbbf96';
const FLOWISE_API_KEY = 'GCsVbQFghmgWibHPFtnD2k5RrEfyD9oWVmXkxHiaCdU';
const API_TIMEOUT = 10 * 60 * 1000; // 10 minutes for long-running flows
