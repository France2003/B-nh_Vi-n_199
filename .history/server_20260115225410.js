...
const app = express();
const PORT = 3001;
const FLOWISE_API_URL = 'https://flowise.imagentu.cloud/api/v1/prediction/32fc0cbd-8829-4d07-abd0-06cead2a5918';
...
app.post('/api/flowise', async (req, res) => {
  ...
  try {
    ...
    try {
      ...
      const systemContext = fileCount > 0 ? `[HỆ THỐNG: ĐÃ ĐÍNH KÈM ${fileCount} FILE: ${fileNames}] ` : '';
      ...
      res.json({
        ...data,
        notebookLink: data.link_notebook || data.additionalParameters?.link_notebook || null,
